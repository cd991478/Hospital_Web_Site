...
- 이름, 생년월일 등의 인적사항은 회원 등록 정보에서 기본값으로 불러오며, 각종 증상 및 해당 사항를 선택하고 개인 정보 수집 동의를 선택 후 등록 버튼을 누르면 문진표가 등록됩니다.
- 등록된 문진표는 문진표 목록 페이지에서 확인 가능하며, 목록의 문진표 번호를 클릭하면 해당 문진표의 세부 정보를 확인할 수 있습니다.
- 문진표 세부 정보 페이지에서 병원 예약, 문진표 수정, 삭제 버튼을 누르면 해당 기능을 수행 할 수 있습니다.
...
- Covid-19 전체 통계 차트 메뉴로 진입하여 등록된 모든 Covid-19 환자의 통계 차트를 조회 할 수 있습니다.
- Covid-19 세부 통계 차트 메뉴로 진입하여 연령대와 성별을 선택 후 조건 적용 버튼을 누르면 해당 조건에 맞는 통계 차트가 하단에 출력됩니다.
