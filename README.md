...
- 로그인 되어있다면, 화면 상단의 네비게이션바의 병원 예약 버튼을 눌러 예약 페이지로 이동합니다.
- 예약 정보와, 병원 선택 후 예약 버튼을 누르면 예약 등록이 완료됩니다.
- 등록된 예약은 예약 목록 페이지에서 확인이 가능하며, 예약 번호를 누르면 예약 정보의 세부 정보를 확인할 수 있습니다.
- 예약 정보 상세 화면에서 예약 취소 버튼을 눌러 예약을 취소할 수 있습니다.
- 병원 예약은 문진표 세부 정보 화면에서도 가능합니다.
